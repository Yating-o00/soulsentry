...
import EnergyRhythm from "@/components/agreements/EnergyRhythm";
import { useEvolutionStats } from "@/hooks/useEvolutionStats";
import { formatOffset, suggestedBufferMinutes } from "@/lib/calibration";
import { Flame, Timer, Activity, RefreshCcw, ShieldCheck, Settings2, Sprout } from "lucide-react";
...
// 「心栈越来越懂你」的数据分析：连续如约 / 时间校准 / 能量节律 / 顺延原因 / 自动化信任度
export default function EvolutionInsightBlocks() {
