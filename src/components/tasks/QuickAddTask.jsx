...
import { Calendar as CalendarIcon, Clock, Plus, Sparkles, Settings, Repeat } from "lucide-react";
...
export default function QuickAddTask({ onAdd }) {
  ...
  const handleSubmit = (e) => {
    ...
    setShowRecurrence(false); // Close recurrence dialog if open
  };
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => {
                      if (value === "custom") {
                        setTask({ ...task, repeat_rule: value }); // Set rule to custom, dialog will handle custom_recurrence
